...
<table class="table-extra table table-striped table-celled">
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">2016-MAY-24</td>
      <td style="text-align:left">最初的预发布版本。 将ePAPR文本导入并删除Power ISA特定元素。</td>
    </tr>
    <tr>
      <td style="text-align:left">0.2</td>
      <td style="text-align:left">2017-DEC-20</td>
      <td style="text-align:left">添加了许多推荐的通用节点名称
        <br>添加了中断扩展
        <br>额外的phy时间
        <br>填写了源码章节中的详细信息
        <br>编辑了变化信息
